...
import { computed, nextTick, onMounted, onUnmounted, onActivated, onDeactivated, ref, shallowRef, toRaw, useSlots, watch, defineAsyncComponent, type CSSProperties } from "vue";
...
import type { QueryResult, ColumnInfo, DatabaseType, ForeignKeyInfo } from "@/types/database";
      ...
      <div v-if="hasData || canShowWhereSearch" class="flex-1 flex flex-col overflow-hidden" @contextmenu="onContextMenu">
        ...
        <div class="flex-1 grid min-h-0 overflow-hidden" :style="contentGridStyle">
          ...
          <div
            ...
            :class="[cellDetailPanelIsBottom ? 'col-start-1 row-start-2 border-t' : 'col-start-2 row-start-1 border-l', { 'detail-drawer-resizing': isResizingDetail }]"
