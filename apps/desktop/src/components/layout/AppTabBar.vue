...
function tabIconClass(tab: QueryTab) {
  ...
  if (tab.mode === "data" || tab.mode === "mongo" || tab.mode === "vector" || tab.mode === "redis" || tab.mode === "hbase" || tab.mode === "structure" || tab.mode === "tableInfo") return "text-emerald-600 dark:text-emerald-400";
