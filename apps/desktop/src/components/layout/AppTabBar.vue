...
function tabIconClass(tab: QueryTab) {
  ...
  if (tab.mode === "data" || tab.mode === "mongo" || tab.mode === "vector" || tab.mode === "redis" || tab.mode === "objects" || tab.mode === "structure" || tab.mode === "tableInfo") return "text-emerald-600 dark:text-emerald-400";
...
function tabMenuIcon(tab: QueryTab) {
  ...
  if (tab.mode === "objects" || tab.mode === "tableInfo") return TableProperties;
                ...
                <TooltipTrigger as-child>
                  ...
                  >
                    <span class="shrink-0" :class="tabIconClass(tab)">
                      ...
                      <TableProperties v-else-if="tab.mode === 'objects' || tab.mode === 'tableInfo'" class="h-3.5 w-3.5" />
