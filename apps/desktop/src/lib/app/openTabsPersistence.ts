...
export interface SavedOpenTab {
  ...
  tableInfoTarget?: QueryTab["tableInfoTarget"];
  tableInfoActiveTab?: QueryTab["tableInfoActiveTab"];
...
export function serializeOpenTabs(tabs: QueryTab[]): SavedOpenTab[] {
  return tabs.map((tab) => ({
    ...
    tableInfoTarget: tab.tableInfoTarget,
    tableInfoActiveTab: tab.tableInfoActiveTab,
